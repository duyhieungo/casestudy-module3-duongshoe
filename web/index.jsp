...
<header>
    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="#" class="logo">
                    <img src="${pageContext.request.contextPath}/resources/images/Duong-Shoe-logo-black.png" width="100"
                         height="70" alt="IMG-LOGO">
                </a>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.jsp"><img src="${pageContext.request.contextPath}/resources/images/Duong-Shoe-logo-black.png"
                                     alt="IMG-LOGO"></a>
        </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${item.getProduct().getCatalogID()}">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        ...
                        <a href="/home?action=more&id=${item.getProduct().getProductID()}"
